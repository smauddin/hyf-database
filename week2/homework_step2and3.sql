...
insert into student (id, name, email, phone, class_id) values (1, 'Kathrine Skrzynski', 'kskrzynski0@nasa.gov', '217-495-5221', 5);
insert into student (id, name, email, phone, class_id) values (2, 'Bartholemy Phinnis', 'bphinnis1@sakura.ne.jp', '852-648-4513', 5);
